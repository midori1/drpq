...
from dpr.models.hf_models import RobertaTensorizer
...
class BiEncoder(nn.Module):
    ...
    def create_biencoder_input(cls,
        ...
        for sample in samples:
            ...
            sample_ctxs_tensors = []
            for ctx in all_ctxs:
                if isinstance(tensorizer, RobertaTensorizer):
                    full_text = ctx['url'] + "<sep>" + ctx['title'] + "<sep>" + ctx['text']
                    encoded_tensor = tensorizer.text_to_tensor(full_text, max_length=max_doc_length)
                    sample_ctxs_tensors.append(encoded_tensor)
                else:
                    sample_ctxs_tensors.append(
            ...
            question_tensors.append(tensorizer.text_to_tensor(question, max_length=max_query_length))
