...
class DenseRetriever(object):
    ...
    def generate_question_vectors(self, questions: List[str], use_cls=False) -> T:
        n = len(questions)
        bsz = self.batch_size
        query_vectors = []
...
def main(args):
    ...
    questions_tensor = retriever.generate_question_vectors(questions, use_cls=args.use_cls)
