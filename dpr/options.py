...
def add_encoder_params(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--query_sequence_length", type=int, default=512, help="Max length of the query sequence")

    parser.add_argument("--clustering", action="store_true")
    parser.add_argument("--first", action="store_true")
    parser.add_argument("--use_cls", action="store_true")

    parser.add_argument("--random_init_cluster", type=str2bool, nargs='?', const=True,
                        help="whether select initial seed cluster randomly")

    parser.add_argument("--n_cluster", type=int, default=-1)
    parser.add_argument("--single_encoder", action="store_true")

    parser.add_argument("--init_from_path", action="store_true", help="If init model from ")
...
def add_training_params(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--log_dir", default='./output/log', type=str)
